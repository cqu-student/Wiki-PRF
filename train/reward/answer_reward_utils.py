...
def preprocess_answer(
    ...
    def _standarize_digits_and_contractions(s):
    ...
    answer = _standarize_digits_and_contractions(answer)
...
def exact_match_scoring_function(reference, candidate):
...
def vqa_match_function(example):
    ...
    matches_exactly = exact_match_scoring_function(example['reference'], example['candidate'])
    if matches_exactly:
        return 1.0
    return 0
